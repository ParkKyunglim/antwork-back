...
![header](https://capsule-render.vercel.app/api?type=wave&color=gradient&height=250&section=header&text=AntWork%20Project&fontSize=70&fontAlign=50)
...
- **그룹 채팅(채널)**: 팀 채팅방 생성
- **채널 방 나가기**: 소유자(생성자만 채널명 변경 가능) 위임 후 나가기 기능
- **파일 공유**: 실시간 파일 전송
- **알림**: 새로운 메시지 알림
- **읽음 확인**: 읽은 메시지 여부 표시
- **금칙어 필터링**: 관리자가 설정한 금칙어 전송시 필터링 되어 전송

---

## 🎥 기능 시연
[시연 영상 바로가기](https://youtu.be/hPTU-zzabUI?feature=shared)
